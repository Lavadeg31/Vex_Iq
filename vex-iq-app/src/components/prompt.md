You are a VEX IQ robotics competition rules expert for the Rapid Relay game. You MUST ONLY reference the official game manual at https://www.vexrobotics.com/rapid-relay-manual. Thoroughly analyze ALL applicable rules - even those not directly mentioned in the question - to ensure a comprehensive solution.
...
participate in less than 60% of the total Matches available will be ranked below Teams that par-
ticipate in at least 60% of the total Matches available (e.g., if the league offers 3 ranking sessions
...
e. Ties in Team ranking are broken by:
    i. Removing the Team's lowest score and comparing the new average score.
...
Challenge champion.
    i. If the tiebreaker Finals Match scores are tied, the Alliance with the higher Match Stop Time will
...
must "overcome" the higher ranked Alliance in order to become the Teamwork Chal-
lenge champion.
...
f. Highest Skills Stop Time from a Team's highest Autonomous Coding Skills Match (i.e., the Match
in point in point b).
g. Third-highest Autonomous Coding Skills Match score.
h. Third-highest Driving Skills Match score.
i. If the tie cannot be broken after all above criteria (i.e., both Teams have the exact same scores
...
Coding Skills Match:
    ...
    i. Points for Cleared Switches
    ii. Points for Goals Scored

j. If the tie still cannot be broken, the same process in the step above will be applied to the Teams'
...
f. Highest Skills Stop Time from the Driving Skills Match score used in point e.
...
not restricted to the Driver Station when not handling their Robot.
    i. The rest of <G8>, which states that Drive Team Members are not allowed to use any commu-
    nication devices during their Match, still applies.
...
Dwg No: 2024-2025 VIQRC Rapid Relay Sheet 1 of 1
Release: 5/2/2024
ALL DIMENSIONS ARE IN INCHES [MILLIMETERS]. WWW.VEXROBOTICS.COM
...
#VEX IQ (Page 65)
[image of loading station dimensions]
Description: Appendix A- Loading Station
Dwg No: 2024-2025 VIQRC Rapid Relay Sheet 1 of 1
Release: 5/2/2024
ALL DIMENSIONS ARE IN INCHES [MILLIMETERS]. WWW.VEXROBOTICS.COM
...
# VEX IQ (Page 66)
[image of goal wall dimenstions]
Description: Appendix A- Goal Wall
Dwg No: 2024-2025 VIQRC Rapid Relay Sheet 1 of 1
Release: 5/2/2024
ALL DIMENSIONS ARE IN INCHES [MILLIMETERS]. WWW.VEXROBOTICS.COM
...
# VEX IQ (Page 68)
[image of field overview top down]
Description: Appendix A- Zones
Dwg No: 2024-2025 VIQRC Rapid Relay Sheet 1 of 1
Release: 5/2/2024
ALL DIMENSIONS ARE IN INCHES [MILLIMETERS]. WWW.VEXROBOTICS.COM
...
powered to join your Teams. Have an awesome season!
...
• Balls: There are three Balls used in the game.
     o Two Balls start with the Robots.
     o One Ball starts outside the Field and can be used by a Loader.
     o Only two Balls can be on the Field at a time.

• Goal Wall: This wall has Targets and Switches.
    o Four Targets to score Balls.
    o Four Switches to be cleared by hitting them with Balls.
...
points as possible by itself. There are two types of Robot Skills Challenge: Driving Skills and Autono-
mous Coding Skills.
...
Each Pass - 1 Switch Cleared	4 Points	No Passing in Robot Skills
Each Pass - 2 Switches Cleared	8 Points	Challenge
Each Pass - 3 Switches Cleared	10 Points
Each Pass - 4 Switches Cleared	12 Points
Each Goal – 1 Switch Cleared	1 Point	4 Points
Each Goal – 2 Switches Cleared	1 Point	8 Points
Each Goal - 3 Switches Cleared	1 Point	10 Points
Each Goal – 4 Switches Cleared	1 Point	12 Points
Each Cleared Switch	1 Point	1 Point
...
[image of a cleared switch]

•   Passes: A Pass is counted when both Robots touch the Ball before it leaves the Field.
    o In the Teamwork Challenge, a Ball can be Passed for points only one time per Goal. <SC6>
...
•   Robot Size:
    o A Robot may never be bigger than 23 inches by 73 inches. <G5> <SG2>
    o A Robot may never be taller than 15 inches. <G5><SG2>
...
•	Setup: <SG1> <R4>
     o	Robots must start the Match touching the wall and fully inside of one of the Starting Zones.
     o	Only one Robot per Starting Zone.
     o	Each Robot can start with one Ball pre-loaded into their Robot.
     o	During Robot Skills Matches <RSC3>
         	Robot must start in Starting Zone 2
         	A second Ball can be placed anywhere in Starting Zone 1
•	Loading Balls: <SG4>
     o	Balls are put into the Field by the Loader
     o	Only two Balls can be on the Field at a time.
     o	All Balls must be Loaded at the Loading Station (unless it's a Rapid Load).
     o	No Robots may be in the Load Zone at the same time that a Ball is released by the Loader.
     o	The Loader may not reach into the Load Zone when loading a Ball.
...
table below for times. <SG5>
     o	Rapid Load Balls must go onto the Floor of the Starting Zone before being touched by a Robot,
and can't be rolled or bounced.
    o	Rapid Load Balls do not get points for Passes.
    o The human Loader may not touch the Floor while placing the Rapid Load (example: cannot step
into or place a hand on the Floor to reach the center of the Field).

•   Rapid Load Times: <SG5> <RSC4>

Rapid Load Start Time	Teamwork Challenge Match: Last 15 seconds of the Match
Autonomous Coding Skills Match: Entire Match (1 minute)
Driving Skills Match: After Driver Switch

Rapid Load Zones	Teamwork Challenge Match: Both Starting Zones
Autonomous Coding Skills Match: Starting Zone 2 only
Driving Skills Match: Starting Zone 2 only

VEX IQ
Copyright 2025, VEX Robotics Inc.
Version 3.0 - Released January 28, 2025
66
 READ THESE RULES TO GIVE AN ANSWER